...
using Polly.Contrib.FallbackBulkheadPolicy.Specs.Helpers;
...
namespace Polly.Contrib.FallbackBulkheadPolicy.Specs
{
    public class BulkheadTResultAsyncSpecs : BulkheadSpecsHelper
    {
            ...
            bool cancelExecuting, string scenario)
        {
            ...
            var bulkhead = AsyncFallbackBulkheadPolicy.Create<ResultPrimitive>(maxParallelization, maxQueuingActions);
